...
export class Conta {
    ...
    public getGruposTransacoes(): GrupoTransacao[] {
        ...
        const transacoesOrdenadas: Transacao[] = listaTrasacoes.sort((t1, t2) => t2.data.getTime() - t1.data.getTime())
    ...
    public registrarNovaTransacao(novaTransacao: Transacao): void {
...
export class ContaPremium extends Conta {
    public registrarTrasacao(transacao: Transacao): void {
        if(transacao.tipoTransacao === TipoTransacao.DEPOSITO) {
            console.log("ganhou um bônus de 50 centavos")
            transacao.valor += 0.5
        }
        super.registrarNovaTransacao(transacao)
    }
}

export const conta = new Conta("José Maria de Assis Filho")
