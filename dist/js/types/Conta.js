...
export class Conta {
    ...
    getGruposTransacoes() {
        ...
        const listaTrasacoes = structuredClone(this.transacoes);
        const transacoesOrdenadas = listaTrasacoes.sort((t1, t2) => t2.data.getTime() - t1.data.getTime());
